...
object Preprocessor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      ...
      .csv("/Users/very/Documents/MP/INF729-Spark/TP_ParisTech_2017_2018_starter/data/train.csv")
    ...
    dfFiltered.write.mode(SaveMode.Overwrite)
      .parquet("/Users/very/Documents/MP/INF729-Spark/TP_ParisTech_2017_2018_starter/data/prepared_trainingset")
